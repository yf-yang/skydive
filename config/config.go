...
func init() {
	...
	cfg.SetDefault("ovs.oflow.ovs_appctl", "/usr/bin/ovs-appctl")
	cfg.SetDefault("ovs.oflow.ovs_ofctl", "/usr/bin/ovs-ofctl")
	cfg.SetDefault("ovs.oflow.ovs_schema", "/usr/share/openvswitch/vswitch.ovsschema")
	cfg.SetDefault("ovs.oflow.ovs_vsctl", "/usr/bin/ovs-vsctl")
	cfg.SetDefault("ovs.oflow.ovs_vswitchd", "/usr/sbin/ovs-vswitchd")
	cfg.SetDefault("ovs.oflow.data", "/tmp/ovssim")
	cfg.SetDefault("ovs.oflow.ovsdb_server", "/usr/sbin/ovsdb-server")
	cfg.SetDefault("ovs.oflow.ovsdb_tool", "/usr/bin/ovsdb-tool")
